...
func IsInvalidGrantType(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INVALID_GRANT_TYPE.String() && e.Code == 400
}

// 400
func ErrorInvalidGrantType(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_INVALID_GRANT_TYPE.String(), fmt.Sprintf(format, args...))
}
...
func IsInvalidUserid(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INVALID_USERID.String() && e.Code == 400
}

// 用户ID无效
func ErrorInvalidUserid(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_INVALID_USERID.String(), fmt.Sprintf(format, args...))
}
...
func IsUserFreeze(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_USER_FREEZE.String() && e.Code == 401
}

// 用户被冻结
func ErrorUserFreeze(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ErrorReason_USER_FREEZE.String(), fmt.Sprintf(format, args...))
}
...
func IsIncorrectAppSecret(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INCORRECT_APP_SECRET.String() && e.Code == 401
}

// 密钥错误
func ErrorIncorrectAppSecret(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ErrorReason_INCORRECT_APP_SECRET.String(), fmt.Sprintf(format, args...))
}
...
func IsIncorrectAccessToken(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INCORRECT_ACCESS_TOKEN.String() && e.Code == 401
}

// 访问令牌错误
func ErrorIncorrectAccessToken(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ErrorReason_INCORRECT_ACCESS_TOKEN.String(), fmt.Sprintf(format, args...))
}
...
func IsIncorrectRefreshToken(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INCORRECT_REFRESH_TOKEN.String() && e.Code == 401
}

// 刷新令牌错误
func ErrorIncorrectRefreshToken(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ErrorReason_INCORRECT_REFRESH_TOKEN.String(), fmt.Sprintf(format, args...))
}
...
func IsTokenNotExist(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_TOKEN_NOT_EXIST.String() && e.Code == 401
}

// token不存在
func ErrorTokenNotExist(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ErrorReason_TOKEN_NOT_EXIST.String(), fmt.Sprintf(format, args...))
}
